...
class ProductItemRequest extends FormRequest
{
    ...
    public function createRules()
    {
        ...
        $this->rules += ['image' => 'nullable|mimes:jpg,svg,bmp,jpeg,gif,png,eps,raw,cr2,nef,orf,sr2,tif,tiff,|max:2048',];
        $this->rules += ['image2' => 'nullable|mimes:jpg,svg,bmp,jpeg,gif,png,eps,raw,cr2,nef,orf,sr2,tif,tiff,|max:2048',];
