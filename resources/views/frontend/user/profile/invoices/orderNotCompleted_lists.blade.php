                ...
                <div class="profile-content">
                    ...
                    <div class="box-bg">
                        ...
                        <div class="table-responsive">
                            ...
                            <td>
                                  <a href="{{route('customer.order.index',['order_id'=>$order->id])}}">@lang('site.completeOrder') </a>
                                {{-- <a href="{{route('customer.orders.detials',([$order->id]))}}">{{ __('site.details') }}</a>
                                        </td> --}}
                        </tr>
