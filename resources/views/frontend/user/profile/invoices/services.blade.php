@extends('layouts.app')
@section('title_page')
@lang('site.orders services')
@php
$profile_bar='services';
@endphp
@endsection
@section('content')
<!-- START => Breadcrumb -->
    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumb-pages">
            <ul class="d-flex align-items-center">
                ...
                <li class="mx-2"> <i class="fa fa-chevron-right fa-sm"></i> </li>
                <li><a href="">@lang('site.orders services')</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-md-9">
                <div class="profile-content">
                    <div class="title-profile px-2">
                        <strong class="h5 d-block">@lang('site.orders services') </strong>
                    </div>
                    <div class="box-bg">
                        <div class="title">
                            <strong>(@lang('site.orders services'))</strong>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td> {{ __('site.'.$invoice->status) }}</td>
                                           <td>  <a href="{{route('customer.orders.services.detials',([$invoice->id]))}}">{{ __('site.details') }}</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
