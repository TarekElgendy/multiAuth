    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumb-pages">
            <ul class="d-flex align-items-center">
                ...
                <li class="mx-2"> <i class="fa fa-chevron-right fa-sm"></i> </li>
                <li><a href="">@lang('site.orders website')</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-md-9">
                <div class="profile-content">
                    <div class="title-profile px-2">
                        <strong class="h5 d-block">@lang('site.orders website') </strong>
                    </div>
                    <div class="box-bg">
                        <div class="title">
                            <strong>(@lang('site.orders website'))</strong>
                        </div>
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <td>  <a href="{{route('customer.orders.websites.detials',([$order->id]))}}">{{ __('site.details') }}</a>
                                        </td>
                                </tr>
                                    @endforeach
                                </tbody>
