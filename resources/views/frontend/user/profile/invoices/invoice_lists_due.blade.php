@extends('layouts.app')
@section('title_page')
@lang('site.invoices_due')
@php
$profile_bar='invoices_due';
@endphp
@endsection
@section('content')
<!-- START => Breadcrumb -->
    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumb-pages">
            <ul class="d-flex align-items-center">
                ...
                <li class="mx-2"> <i class="fa fa-chevron-right fa-sm"></i> </li>
                <li><a href="">@lang('site.invoices_due')</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-md-9">
                <div class="profile-content">
                    <div class="title-profile px-2">
                        <strong class="h5 d-block">@lang('site.invoices_due') </strong>
                    </div>
                    <div class="box-bg">
                        <div class="title">
                            <strong>(@lang('site.invoices_due'))</strong>
                        </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('site.renew')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($orders as $index=>$order)
                                    <tr style="background-color:{{ $order->status=="completed" ? '#04fb0938' : '#f1d4d4'}}">
                                        <td>{{ $index + 1 }}</td>
                                        ...
                                        <td style="background: {{ $order->payment_status=='completed'?'#a9ff02' :'#fa5068' }}">
                                        ...
                                        <td>
                                       <a href="{{route('customer.profile.renewal',(['order_id'=>$order->id]))}}">{{ __('site.renew') }}</a>


                                             {{-- <a href="{{route('customer.profile.renewal')}}">{{ __('site.renewal') }}</a> --}}
