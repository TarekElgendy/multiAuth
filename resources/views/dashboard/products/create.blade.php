                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input"  name="category_id[]" type="checkbox" {{ old('category_id')==$category->id?'checked':'' }} value="{{ $category->id }}" id="{{ $category->id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="mainPage" required="required" class="form-control">
                                                ...
                                                @foreach (activeOrinactive() as $item)
                                                    <option value="{{ $item }}" {{ old('mainPage')==$item?'selected':'' }}> {{ __('dash.' . $item) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="status" required="required" class="form-control">
                                                <option value="">@lang('dash.select')</option>
                                                @foreach (activeOrinactive() as $item)
                                                    <option value="{{ $item }}"  {{ old('status')==$item?'selected':'' }}> {{ __('dash.' . $item) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
